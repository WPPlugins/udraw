<?php
    if (is_user_logged_in()) {
        if (!current_user_can('read_udraw_block_templates')) { // viewing & editing permissions
            exit;
        }
    } else {
        exit;
...
<div class="wrap" id="manage-designs-page">
    <h2>
        <i class="fa fa-picture-o"></i><?php _e('XMPie Templates', 'udraw') ?>
    </h2>                
    ...
    $myListTable = new uDraw_XMPie_Templates_Table();
