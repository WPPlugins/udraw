...
<div data-udraw="toolboxOverlay"></div>
<div id="udraw-main-designer-ui" style="height: 750px; position: relative;">
         
        <?php if (isset($load_frontend_navigation)) { ?>
            <?php include_once(UDRAW_PLUGIN_DIR . '/designer/bootstrap-fullscreen/designer-template-header-menu.php'); ?>
        <?php } else { ?>
            <?php include_once(UDRAW_PLUGIN_DIR . '/designer/bootstrap-fullscreen/designer-template-header-menu-admin.php'); ?>
        <?php } ?>
        ...
        <div id="designer-left-toolbar" data-udraw="designerSideBar">
            <div id="canvas-background-btn-holder" class="btn-group btn-group-sm" data-udraw="backgroundColourContainer">
                <a href="#" class="btn btn-primary btn-sm hover-icon" id="canvas-background-btn" data-toggle="tooltip-top" data-i18n="[data-original-title]tooltip.background-colour" data-udraw="backgroundColour">
            ...
            <div class="btn-group" data-udraw="textGroup" data-toggle="tooltip-top" data-i18n="[data-original-title]tooltip.create-text">
                <button type="button" class="btn btn-primary btn-sm dropdown-toggle hover-icon" onclick="javascript: RacadDesigner.Freedraw.disableDrawMode();" data-toggle="dropdown">
            ...
            <div class="btn-group" id="multiple-image-btn-group" data-toggle="tooltip-top" data-i18n="[data-original-title]tooltip.insert-image" data-udraw="imagesGroup">
                ...
                <ul class="dropdown-menu left-dropdown" id="images-dropdown" role="menu">
                    <li style="padding-left:20px;" id="Upload-Image-list-container">
                    ...
                    <?php } ?>
                    <?php if ($_udraw_settings['designer_enable_flickr_photos']) { ?>
                        <li id="Flickr-Uploads-list-container">
                            <a href="#" id="flickr-image-btn" data-udraw="flickrPhotos">
                                <i class="fa fa-flickr icon"></i>&nbsp; <span data-i18n="[html]menu_label.flickr-uploads"></span>
                            </a>
                        </li>
                    <?php } ?>
                </ul>
            ...
            <a href="#" class="btn btn-primary btn-sm hover-icon" id="qrcode-toolbar-btn" data-toggle="tooltip-top" data-i18n="[data-original-title]tooltip.open-qr" data-udraw="qrCode">
            ...
            <div class="btn-group btn-group-sm" id="multiple-shapes-btn-group" data-toggle="tooltip-top" data-i18n="[data-original-title]tooltip.create-shape" data-udraw="shapesGroup">
                ...
                <ul class="dropdown-menu left-dropdown" role="menu">
                    <li id="Circle-list-container">
                        <a href="#" id="shapes-circle-add-btn" data-udraw="addCircle"><img src="<?php echo UDRAW_DESIGNER_IMG_PATH; ?>circle-icon.png" class="shape-icon" />&nbsp;<span data-i18n="[html]menu_label.circle-shape"></span></a>
                        <hr class="list-hr-divider"/>
                    </li>
                    <li id="Rectangle-list-container">
                        <a href="#" id="shapes-sqaure-add-btn" data-udraw="addRectangle"><img src="<?php echo UDRAW_DESIGNER_IMG_PATH; ?>square-icon.png" class="shape-icon" />&nbsp;<span data-i18n="[html]menu_label.rect-shape"></span></a>
                        <hr class="list-hr-divider" />
                    </li>
                    <li id="Triangle-list-container">
                        <a href="#" id="shapes-triangle-add-btn" data-udraw="addTriangle"><img src="<?php echo UDRAW_DESIGNER_IMG_PATH; ?>triangle-icon.png" class="shape-icon" />&nbsp;<span data-i18n="[html]menu_label.triangle-shape"></span></a>
                        <hr class="list-hr-divider" />
                    </li>
                    <li id="Line-list-container">
                        <a href="#" id="shapes-line-add-btn" data-udraw="addLine"><img src="<?php echo UDRAW_DESIGNER_IMG_PATH; ?>line-icon.png" class="shape-icon" />&nbsp;<span data-i18n="[html]menu_label.line-shape"></span></a>
                        <hr class="list-hr-divider" />
                    </li>
                    <li id="Curved-line-list-container">
                        <a href="#" id="shapes-curved-line-add-btn" data-udraw="addCurvedLine"><img src="<?php echo UDRAW_DESIGNER_IMG_PATH; ?>curved-line-icon.png" class="shape-icon" />&nbsp;<span data-i18n="[html]menu_label.curved-line-shape"></span></a>
                        <hr class="list-hr-divider" />
                    </li>
                    ...
                    <li id="Star-list-container">
                        <a href="#" id="shapes-star-add-btn" data-udraw="addStar"><img src="<?php echo UDRAW_DESIGNER_IMG_PATH; ?>star-icon.png" class="shape-icon" />&nbsp;<span data-i18n="[html]menu_label.star-shape"></span></a>
                    </li>
                </ul>
            </div>
            <?php } ?>
            <!-- END SHAPES-->
            <!--FREE DRAW-->
            <a href="#" class="btn btn-primary btn-sm hover-icon" id="freedraw-btn" data-toggle="tooltip-top" data-i18n="[data-original-title]tooltip.enable-freedraw" data-udraw="freedrawButton">
        ...
        <div data-udraw="body_block">
            ...
            <div id="toolbox-holder" data-udraw="toolboxContainer">
                ...
                <!-- 3d box dialog -->
                <div class="modal toolbox-modal" id="threeD-box-modal" style="top:100px;" data-udraw="threeDBoxModal">
                    <div class="modal-dialog modal-md" style="margin: 0px auto 0px auto;">
                        <div class="modal-content">
                            <div class="modal-header toolbox-header">
                                <span data-i18n="[html]menu_label.threed-box"></span>
                                <div class="modal-header-btn-container" style="float:right;">
                                    <a href="#" class="btn btn-default btn-xs hide-toolbox" id="hide-threedbox-control" style="padding-top:0px;" data-udraw="toolboxHide"><i class="fa fa-chevron-up"></i><span id="Span1" data-i18n="[html]common_label.hide"></span></a>
                                    <a href="#" class="btn btn-default btn-xs" id="close-threedbox-control" style="padding-top:0px;" data-udraw="toolboxClose"><i class="fa fa-close"></i><span data-i18n="[html]common_label.close"></span></a>
                                </div>
                            </div>
                            <div class="modal-body toolbox-body" style="overflow-x: hidden;">
                                <div class="panel-body designer-panel-body" id="threed-box-body">
                                    <div class="row" id="threedbox-create-btn-area" data-udraw="threedBoxCreateContainer">
                                        <a href="#" id="threedbox-create-btn" class="btn btn-xs btn-success col-sm-3" style="margin-left:15px;" data-udraw="threedBoxCreate"><i class="fa fa-plus-circle"></i>&nbsp;<span data-i18n="[html]common_label.create"></span></a>
                                    </div>
                                </div>
                                <div id="threedbox-control-div" style="display:none; padding-left: 21px; margin-top: -20px; padding-bottom: 15px;" data-udraw="threedBoxControlContainer">
                ...
                <div class="modal toolbox-modal" id="threeD-preview-modal" style="top: 150px;" data-udraw="threeDPreviewModal">
                    <div class="modal-dialog modal-md" style="margin: 0px auto 0px auto;">
                        <div class="modal-content">
                            <div class="modal-header toolbox-header">
                                <span data-i18n="[html]menu_label.threed-preview"></span>
                                <div class="modal-header-btn-container" style="float:right;">
                                    <a href="#" class="btn btn-default btn-xs hide-toolbox" id="hide-threedpreview-control" style="padding-top:0px;" data-udraw="toolboxHide"><i class="fa fa-chevron-up"></i><span id="Span2" data-i18n="[html]common_label.hide"></span></a>
                                    <a href="#" class="btn btn-default btn-xs" id="close-threedpreview-control" style="padding-top:0px;" data-udraw="toolboxClose"><i class="fa fa-close"></i><span data-i18n="[html]common_label.close"></span></a>
                                </div>
                            </div>
                            <div class="modal-body toolbox-body" style="overflow-x: hidden;">
                                <div class="panel-body designer-panel-body" id="threed-preview-body">
        ...
        <div class="modal overlay-modal" id="browse-templates-modal" data-udraw="templatesModal">
        ...
        <div class="modal overlay-modal" id="browse-private-templates-modal" data-udraw="privateTemplatesModal">
                    ...
                    <div class="modal-body">
                        <div class="container-fluid">
                            <div class="row">
                                ...
                                <div id="private-templates-category-content" class="col-md-10" style="display:inline-block; width: calc(90% - 250px);">
        ...
        <div class="modal overlay-modal" data-udraw="apparelGraphicsModal">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
        ...
        <?php } ?>
        <!-- Progress Bar Dialog -->
        <div class="modal overlay-modal" id="progress-bar-modal" data-udraw="progressModal">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
        ...
        <!-- Local Images Dialog -->
        <div class="modal overlay-modal" id="local-images-modal" data-udraw="userUploadedModal">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
        ...
        <div class="modal overlay-modal" id="clipart-collection-modal" data-udraw="clipartModal">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
        ...
        <div class="modal overlay-modal" id="private-clipart-collection-modal" data-udraw="privateClipartModal">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <strong style="font-size:large;"><span data-i18n="[html]header_label.image-header"></span></strong>
        ...
        <!-- QR Code Dialog -->
        <div class="modal overlay-modal" id="qrcode-modal" data-udraw="qrModal">
        ...
        <!-- Wizard Dialog -->
        <div class="modal overlay-modal" id="wizard-modal" data-udraw="wizardModal">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                                ...
                                <div class="col-md-5">
                                    ...
                                    <div id="wizard-options-area">
                                        <div id="wizard-bc-options">
                                            <input type="radio" name="product-size" value="3.5,2,bc,2.5" checked="checked" /><strong>&nbsp;3.5" x 2" (Horizontal)</strong>
                                            <br />
                                            <input type="radio" name="product-size" value="2,3.5,bc,1.85" /><strong>&nbsp;2" x 3.5" (Vertical)</strong>
                                        </div>
                                        <div id="wizard-brochure-options" style="display:none;">
                                            <input type="radio" name="product-size" value="11,8.5,brochure,0.8" /><strong>&nbsp;11" x 8.5" (Letter)</strong>
                                            <br />
                                            <input type="radio" name="product-size" value="14,8.5,brochure,0.6" /><strong>&nbsp;14" x 8.5" (Legal)</strong>
                                            <br />
                                            <input type="radio" name="product-size" value="17,11,brochure,0.5" /><strong>&nbsp;17" x 11" (Tabloid)</strong>
                                        </div>
                                        <div id="wizard-envelope-options" style="display:none;">
                                            <input type="radio" name="product-size" value="6,3.5,envelope,1.45" /><strong>&nbsp;6" x 3.5" (#6)</strong>
                                            <br />
                                            <input type="radio" name="product-size" value="7.5,3.875,envelope,1.15" /><strong>&nbsp;7.5" x 3.875" (#7 3/4 Monarch)</strong>
                                            <br />
                                            <input type="radio" name="product-size" value="8.875,3.875,envelope,1" /><strong>&nbsp;8.875" x 3.875" (#9)</strong>
                                            <br />
                                            <input type="radio" name="product-size" value="9.5,4.125,envelope,0.9" /><strong>&nbsp;9.5" x 4.125" (#10)</strong>
                                            <br />
                                            <input type="radio" name="product-size" value="10.375,4.5,envelope,0.85" /><strong>&nbsp;10.375" x 4.5" (#11)</strong>
                                            <br />
                                            <input type="radio" name="product-size" value="11,4.5,envelope,0.8" /><strong>&nbsp;11" x 4.5" (#12)</strong>
                                            <br />
                                            <input type="radio" name="product-size" value="11.5,5,envelope,0.75" /><strong>&nbsp;11.5" x 5" (#14)</strong>
                                        </div>
                                        <div id="wizard-flyers-options" style="display:none;">
                                            <input type="radio" name="product-size" value="8.5,5.5,flyers,1.05" /><strong>&nbsp;8.5" x 5.5"</strong>
                                            <br />
                                            <input type="radio" name="product-size" value="8.5,11,flyers,0.8" /><strong>&nbsp;8.5" x 11"</strong>
                                            <br />
                                            <input type="radio" name="product-size" value="5.5,4,flyers,1.6" /><strong>&nbsp;5.5" x 4"</strong>
                                            <br />
                                        </div>
                                        <div id="wizard-gc-options" style="display:none;">
                                            <input type="radio" name="product-size" value="5,3.5,gc,1.75" /><strong>&nbsp;5" x 3.5"</strong>
                                            <br />
                                            <input type="radio" name="product-size" value="6,4,gc,1.45" /><strong>&nbsp;6" x 4"</strong>
                                            <br />
                                            <input type="radio" name="product-size" value="5.5,4.25,gc,1.6" /><strong>&nbsp;5.5" x 4.25"</strong>
                                            <br />
                                            <input type="radio" name="product-size" value="6,4.25,gc,1.45" /><strong>&nbsp;6" x 4.25"</strong>
                                            <br />
                                            <input type="radio" name="product-size" value="7,5,gc,1.25" /><strong>&nbsp;6" x 4.25"</strong>
                                            <br />
                                        </div>
                                        <div id="wizard-lh-options" style="display:none;">
                                            <input type="radio" name="product-size" value="8.5,11,lh,0.8" /><strong>&nbsp;8.5" x 11" (Standard)</strong>
                                            <br />
                                            <input type="radio" name="product-size" value="8.5,14,lh,0.65" /><strong>&nbsp;8.5" x 14"</strong>
                                            <br />
                                            <input type="radio" name="product-size" value="11,17,lh,0.5" /><strong>&nbsp;11" x 17"</strong>
                                            <br />
                                        </div>
                                        <div id="wizard-postcard-options" style="display:none;">
                                            <input type="radio" name="product-size" value="6,4,postcard,1.45" /><strong>&nbsp;6" x 4"</strong>
                                            <br />
                                            <input type="radio" name="product-size" value="6,4.25,postcard,1.45" /><strong>&nbsp;6" x 4.25"</strong>
                                            <br />
                                            <input type="radio" name="product-size" value="7,5,postcard,1.25" /><strong>&nbsp;7" x 5"</strong>
                                            <br />
                                            <input type="radio" name="product-size" value="8.5,5.5,postcard,1.05" /><strong>&nbsp;8.5" x 5.5"</strong>
                                            <br />
                                            <input type="radio" name="product-size" value="9,6,postcard,1" /><strong>&nbsp;9" x 6"</strong>
                                            <br />
                                            <input type="radio" name="product-size" value="11,6,postcard,0.8" /><strong>&nbsp;11" x 6"</strong>
                                            <br />
                                        </div>
                                    ...
                                    <div id="wizard-create-btn-area" class="col-md-6" style="margin-top:15px; float:right;">
                                        <div class="col-md-12">
        ...
        <div class="modal overlay-modal" id="document-properties-modal" data-udraw="settingsModal">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <strong style="font-size:large;"><span data-i18n="[html]menu_label.settings"></span></strong>
                        <a href="#" class="btn btn-danger" data-dismiss="modal" style="padding: 6px 10px; color: #fff;"><span data-i18n="[html]common_label.cancel"></span></a>
                        <a href="#" class="btn btn-success" tabindex="3" id="update-document-properties-btn" style="float: right;"><span data-i18n="[html]common_label.update"></span></a>
                    </div>
                    <div class="modal-body">
                        <div id="document-properties-div">
                            <form class="form-horizontal" role="form">
                                <div class="form-group">
                                    ...
                                    <div data-udraw="settings_warning">
                                        <span data-i18n="[html]text.settings_warning_pt1"></span><span data-udraw="ratio_suggest_num">0</span><span data-i18n="[html]text.settings_warning_pt2"></span>
                                    </div>
                                    ...
                                    <div class="checkbox col-sm-offset-1 checkbox col-sm-11 document-settings-container">
                                        ...
                                        <select data-udraw="selectPDFratio" style="width:75px">
                            ...
                            <div style="display: inline-block;">
                                ...
                                <a href="#" class="btn btn-default" data-udraw="toggleLabelsContainer"><span data-i18n="[html]text.labels-settings-btn"></span></a>
                            </div>
                            <div style="max-height: 200px; overflow-y: auto; overflow-x: hidden">
                                <div data-udraw="layerLabelsContainer" class="settings-container" style="display: none;">
                                    <div style="padding-left: 15px; padding-top: 15px;">
                                        <strong><span data-i18n="[html]text.layers-labels"></span></strong>
                                        <a href="#" style="float: right; margin-right: 15px;" data-i18n="[html]button_label.preview-form" data-udraw="previewLabelsForm"></a>
                                    </div>
                                    <div class="restriction-list-container" data-udraw="layerLabelsList" style="width: 100%;"></div>
                                    <span data-i18n="[html]text_label.layer-labels-name"></span>&nbsp;<input type="text" data-udraw="layerLabelText" data-i18n="[placeholder]text.layer-labels-placeholder" />&nbsp;
                                    <span data-i18n="[html]text_label.layer-labels-type"></span>&nbsp;
                                    <select data-udraw="layerLabelSelect">
                                        <option value="text" data-i18n="[html]common_label.text"></option>
                                        <option value="image" data-i18n="[html]common_label.image"></option>
                                    </select>&nbsp;
                                    <a href="#" class="btn btn-default btn-sm" data-i18n="[html]common_label.add" data-udraw="addLayerLabel"></a>
                                    <br/>
                                    <span style="font-size: 12px;" data-i18n="[html]text.no-special-characters"></span>
                                </div>
                                <div id="restrict-designer-controls-div"  class="settings-container" data-udraw="restrictionsContainer" style="display: none;">
                                ...
                                <div id="disable-designer-functions-div"  class="settings-container" data-udraw="disableFunctionsContainer" style="display: none;">
        ...
        <div class="modal overlay-modal" id="facebook-images-modal" data-udraw="facebookModal">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
        ...
        <div class="modal overlay-modal" id="instagram-images-modal" data-udraw="instagramModal">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
        ...
        <!-- Flickr Images Dialog -->
        <div class="modal" id="flickr-images-modal" data-udraw="flickrModal">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <strong style="font-size:large;"><span>Flickr Photos</span></strong>
                        <div style="float: right;">
                            <a href="#" class="btn btn-default" data-udraw="flickrLogin"><i class="fa fa-flickr" style="border-right: 1px solid #cccccc; margin-right: 5px; padding-right: 5px;"></i><span>Login / Authenticate</span></a>
                            <a href="#" class="btn btn-default" data-udraw="flickrLogout" style="display: none;"><i class="fa fa-flickr" style="border-right: 1px solid #cccccc; margin-right: 5px; padding-right: 5px;"></i><span>Logout / Deauthenticate</span></a>
                        </div>
                    </div>
