...
<div id="udraw-bootstrap" data-udraw="uDrawBootstrap">
    ...
    <?php } ?>
    <div  id="udraw-add-template-page" style="width:100%;" >    
        <p style="padding-left:10px; padding-top:5px;"> 
            <label for="udraw_template_name_txt"><?php _e('Template Name:', 'udraw') ?> </label>
            <input type="text" id="udraw_template_name_txt" name="udraw_template_name" value="New Template" style="width:300px;">
        </p>
    </div>
...
<script type="text/javascript">
    ...
    function _SaveDesign_Response(data) {
        ...
        if (data.errorMessage.length < 2) {
            ...
            var docPages = RacadDesigner.pages.length;
