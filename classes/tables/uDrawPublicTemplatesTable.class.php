...
class uDraw_Public_Templates_Table extends WP_List_Table {
    ...
    function prepare_items()
    {
        ...
        // Get all categories
        $json = $uDrawUtil->get_web_contents(UDRAW_DRAW_SERVER_URL .'/api/category');
        $this->_categories = json_decode($json);
        ...
        $json = $uDrawUtil->get_web_contents(UDRAW_DRAW_SERVER_URL .'/api/templates/' . $category_id);
