...
if (!class_exists('uDrawSettings')) {
    class uDrawSettings {
        ...
        public function get_settings() {
            ...
            $settings = array();
            if (is_multisite()) {
                $settings = get_site_option('udraw_settings');
            } else {
            ...
            $default_settings['designer_skin'] = 'fullscreen';
            $default_settings['designer_skin_theme'] = 'default';
            ...
            if (is_multisite()) {
                update_site_option('udraw_settings', $settings);
            } else {
        ...
        public function update_settings() {
            if (isset($_POST['save_udraw_settings']) ) {                
                $setting_tab = (isset($_GET['tab'])) ? $_GET['tab'] : '';
                $settings = $this->get_settings();
                switch ( $setting_tab ) {
                    case "designer-ui" :
                        ...
                        $settings['designer_skin_theme'] = stripslashes($_POST['designer_skin_theme']);
