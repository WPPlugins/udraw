...
if (!class_exists('uDrawUpload')) {
    ...
    class uDrawUpload {
            ...
            if ($type == 'image/svg+xml' || $type == 'application/font-woff' || $type == 'application/postscript') {
                if (function_exists('finfo_open')) {
                    ...
                    if ($type == 'application/font-woff' || $type == 'application/postscript') {
                        ...
                        if ( ($real_mime !== 'application/octet-stream') && ($real_mime !== $type) ) { 
                            $type = $ext = false;
                        }
                    } else {
        ...
        public function handle_upload($files, $upload_dir = UDRAW_TEMP_UPLOAD_DIR, $upload_url = UDRAW_TEMP_UPLOAD_URL, $mimes = null) {
