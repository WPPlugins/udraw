            ...
            if (isset($_GET['tab']) && $_GET['tab'] == "goepower") { 
                ...
                if (!$isGoepowerValid) {
                    ...
                    if (strlen($_udraw_settings['goepower_company_id']) == 0) {                        
                        ...
                        $udrawSettings->update_setting('goepower_company_id', $_goepower_companies[0]->CompanyID);
                        $_udraw_settings['goepower_company_id'] = $_goepower_companies[0]->CompanyID;                                 
                    }
                }
            }
            ...
            <tbody>
                ...
                <tr valign="top">
                    <th scope="row" class="titledesc">
                        <label for="">uDraw Designer Skin</label>
                    </th>
                    <td class="forminp">
                ...
                <tr valign="top" id="designer_skin_theme_row" style="display: none;">
                    <th scope="row" class="titledesc">
                        <label for="">"Modern" Skin Theme (beta)</label>
                    </th>
                    <td class="forminp">
                        <select name="designer_skin_theme" style="min-width: 300px; display: none; " class="chosen-udraw" id="designer_skin_theme">
                            <?php
                                $themes = array (
                                    'default' => 'Default',
                                    'sleekBlack' => 'Sleek (Black)',
                                    'icyBlue' => 'Icy Blue'
                                );
    
                                foreach ( $themes as $value => $name ) {
                                    $selected = "";
                                    if ($_udraw_settings['designer_skin_theme'] == $value) {
                                        $selected = "selected";
                                    }
                                    echo "<option class=\"level-0\" value=\"" . $value . "\" ". $selected .">". $name ."</option>";
                                }    
                        ...
                        <div id="modern_theme_swatch" style="width: 25px; height: 25px; background: linear-gradient(#EEEEEE, #C2C2C2); display: inline-block; margin-bottom: -10px;"></div>
                        <span class="description"><br><?php _e('Theme for uDraw Designer Skin. This is available only if Designer Skin is set as Modern.', 'udraw') ?></span>
                    </td>
                </tr>
                                
                <tr valign="top">
                    <th scope="row" class="titledesc">
                        <label for="">uDraw Designer Language</label>
                    </th>
                    <td class="forminp">
                        <select name="udraw_designer_language" style="min-width: 300px; display: none;" class="chosen-udraw" id="udraw_designer_language">
                            <?php
                                ...
                                foreach ($availableLanguages as $thisLanguage) {
                                    ...
                                    $file_dir = (file_exists(UDRAW_PLUGIN_DIR.'/designer/includes/locales/udraw-'.$thisLanguage.'.txt')) ? UDRAW_PLUGIN_DIR.'/designer/includes/locales/udraw-'.$thisLanguage.'.txt' : UDRAW_LANGUAGES_DIR.'udraw-'.$thisLanguage.'.txt';
                ...
                <tr valign="top" class="">
                    ...
                    <td class="forminp forminp-checkbox">
                        <fieldset>
                            ...
                            <?php _e('Images uploaded will be forced scaled to meet the minimum DPI requirement.', 'udraw') ?></label>
                            <br>
...
function udraw_social_media_settings_html($_udraw_settings) {
    ...
    <div>
        ...
        <p class="description">
            <?php _e('Register for applications at developers.facebook.com and www.instagram.com/developer, for Facebook and Instagram respectively. You will need to login to your account or create one.', 'udraw'); ?>
        </p>
        <br>
        <p class="description" style="font-weight: bold;">
        ...
        <p class="description">
            <?php _e('Hover over "My Apps" in the menu bar, and select "Add a New App". Select "Website" in the popup window, and follow the instructions on screen. Once the application have been made, navigate to the Settings tab in the sidebar. This is where the App ID required is located. Copy the string of numbers and enter it in the Facebook App ID field above.', 'udraw'); ?>
        </p>
        <p class="description">
            <?php _e('Note: you may be required to submit your application to the Facebook team for reviewing before the application can be used by the public.', 'udraw'); ?>
        </p>
        <br>
        <p class="description" style="font-weight: bold;">
        ...
        <p class="description">
            <?php _e('Click on "Manage Clients" in the top menu bar, and then "Register a New Client". Follow the instructions on screen. Please register your redirect uri as [baseURL]/wp-admin/admin-ajax.php. You will be required to submit your application to Instagram for reviewing before it can Go Live for public usage. Once your application have been made, the Client ID will be shown. Please copy this and enter in the Instagram Client ID field above.', 'udraw'); ?>
        </p>
    </div>
    <?php
}
                ...
                if (strlen($_udraw_settings['goprint2_api_key']) > 1) {
                    ...
                    <tr valign="top">
                        ...
                        <td class="forminp forminp-text">
                            ...
                            <span class="description"><br><?php _e('This feature is for Price Matrix uploads with mode set as "area".', 'udraw') ?></span>
                        </td>
                    </tr>
                    <?php
                }
...
                    
            ...
            jQuery('#designer_skin').on('change', function(){
               if (jQuery(this).val() == 'modern') {
                   jQuery('#designer_skin_theme_row').show();
               } else {
                   jQuery('#designer_skin_theme_row').hide();
               }
            });
            
            <?php if ($_udraw_settings['designer_skin'] == 'modern') { ?>
                jQuery('#designer_skin_theme_row').show();
            <?php } ?>
            
            jQuery('#designer_skin_theme').on('change', function(){
                var value = jQuery(this).val();
                if (value == 'default') {
                    jQuery('#modern_theme_swatch').css('background', 'linear-gradient(#EEEEEE, #C2C2C2)');
                } else if (value == 'sleekBlack') {
                    jQuery('#modern_theme_swatch').css('background', 'linear-gradient(#9F9F9F, #000000)');
                } else if (value == 'icyBlue') {
                    jQuery('#modern_theme_swatch').css('background', 'linear-gradient(#DCEFFF, #91CBFF)');
                }
            });
            
            <?php if ($_udraw_settings['designer_skin_theme'] == 'default') { ?>
                jQuery('#modern_theme_swatch').css('background', 'linear-gradient(#EEEEEE, #C2C2C2)');
            <?php } else if ($_udraw_settings['designer_skin_theme'] == 'sleekBlack') { ?>
                jQuery('#modern_theme_swatch').css('background', 'linear-gradient(#949494, #000000)');
            <?php } else if ($_udraw_settings['designer_skin_theme'] == 'icyBlue') { ?>
                jQuery('#modern_theme_swatch').css('background', 'linear-gradient(#DCEFFF, #50ADFF)');
            <?php } ?>
