...
class uDraw_Price_Matrix_Table extends WP_List_Table {
    ...
    function prepare_items()
    {
        ...
        $this->items = $wpdb->get_results($wpdb->prepare("SELECT id, name, create_date, modify_date, access_key FROM $table_name WHERE name LIKE $search ORDER BY $orderby $order",  $per_page), ARRAY_A);             
