...
<?php
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="tree_view">
                                <div class="tree_view_container">
                                    <ul class="tree_view_list tree_branch_list">
                                        <li class="tree_branch root"><i class="fa fa-plus-square-o expand_branch"></i><span class="tree_branch_span">Price Matrix</span>
                            ...
                            <td class="content_view">
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <input type="text" class="display_name" value=""/>
                                            </div>
                                ...
                                <div class="price_matrix_settings_container">
    ...
    function get_price_matrix_settings($xml) {
        ...
        $_field_options['ShowPages'] = false;
    ...
    function get_price_matrix_help() {
        $_settings = array(
            ...
            'ShowPages' => 'Show Pages entry text box',
        ...
        $_mode = array (
            ...
            'Linear Quantity' => '(Width + Height) x 2 * Quantity',
            'Linear Records' => '(Width + Height) x 2 * Records (or Pages)',
            'Linear Total' => '(Width + Height) x 2 * Quantity * Records (or Pages)'
        );
