...
<form id="price_matrix_form" method="post" action="">
    ...
    <div id="udraw-bootstrap">        
        ...
        <div id="udraw-price-matrix-designer" style="display:none;">
            ...
            include_once(UDRAW_PLUGIN_DIR . '/designer/bootstrap-fullscreen/designer-template-wrapper.php');
            ?>
        </div>
    </div>
</form>
...
<script type="text/javascript"> 
    ...
    var selectedOutput = '';
    var selectedPrice = '';
    var priceHandler = 'https://draw.racadtech.com/service/PriceHandler.ashx';
    //var priceHandler = '/udraw/remote/PriceHandler.ashx';
        ...
        $('#fileupload').fileupload({
            ...
            dataType: 'json',
                ...
                for (var x = 0; x < data.result.length; x++) {
                    ...
                    jQuery('#upload-successful-span').after('<label class="col-md-12" style="font-size:10pt;"><strong>Uploaded</strong>: ' + data.result[x].name + '</label>');
                }
